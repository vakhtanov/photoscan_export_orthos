...
FileRazgr=os.path.dirname(__file__)+"/orthoexport_1planshet_razgrafka.txt"

#ЗДЕСЬ ПОМЕНЯТЬ ПУТИ!!!
OFolder="D:\\KRASNODAR_POREZ\\TEST_ORTHOS\\"
#ЗДЕСЬ ЗАДАТЬ ИМЯ ПЛАНШЕТА
OName="Ko-102-546"
...
print(cu_string) 		
#эти данные можно в цикле или для экспорта
XMLeft=float(cu_string[1])
YMDown=float(cu_string[2])
cu_Region=(XMLeft-difX,YMDown-difY,XMLeft+sizeXMround+difX,YMDown+sizeYMround+difY)
print (sizeXMpix," ",sizeYMpix," ",XMLeft," ",YMDown," ",sizeXMround," ",sizeYMround)
#экспорт в ЮТМ
